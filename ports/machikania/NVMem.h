...
extern unsigned int NVMemWriteWord(const void* address, unsigned int data);
extern unsigned int NVMemErasePage(const void* address);
extern unsigned int NVMemWriteRow(const void* address, const void* data);
